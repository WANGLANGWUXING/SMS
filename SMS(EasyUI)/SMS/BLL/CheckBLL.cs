...
namespace BLL
{
    public class CheckBLL
    {
        ...
        {
            return CheckDAL.GetReckoningView(type,pageSize,pageIndex);
        }

        public static int CountReckoning(string type)
        {
            return CheckDAL.CountReckoning(type);
        }
        /// <summary>
        /// 获取未付金额
        /// </summary>
        ...
        {
            return CheckDAL.GetStockpileView(searchSql,pageSize,pageIndex);
        }

        public static int CountStockpile()
        {
            return CheckDAL.CountStockpile();
        }
        ...
        {
            return CheckDAL.GetTotalView(pageSize,pageIndex);
        }

        public static int CountTotal()
        {
            return CheckDAL.CountTotal();
        }
        /// <summary>
        /// 改变商品数量
        /// </summary>
        ...
        {
            return CheckDAL.GetSaleTable(pageSize,pageIndex);
        }
        public static int CountDaySale()
        {
            return CheckDAL.CountDaySale();
        }
